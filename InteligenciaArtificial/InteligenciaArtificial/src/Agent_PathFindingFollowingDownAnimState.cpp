...
Agent_PathFindingFollowingDownAnimState::Agent_PathFindingFollowingDownAnimState(
...
void Agent_PathFindingFollowingDownAnimState::Enter(PathFindingAgent* agent)
{
	Agent_PathFindingAnimState::Enter(agent);
}

eAGENT_PATH_FINDING_ANIM_STATE_TYPE Agent_PathFindingFollowingDownAnimState::Update(
...
void Agent_PathFindingFollowingDownAnimState::Exit(PathFindingAgent* agent)
{
