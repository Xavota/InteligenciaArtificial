...
*/
class Agent_PathFindingFollowingDownAnimState : public Agent_PathFindingAnimState
{
public:
	/**
	  ...
	  * @bug	    No know Bugs
	*/
	Agent_PathFindingFollowingDownAnimState(std::vector<sf::IntRect> sequence, sf::Texture* atlasMap, float fps, bool repeat);
	~Agent_PathFindingFollowingDownAnimState();
