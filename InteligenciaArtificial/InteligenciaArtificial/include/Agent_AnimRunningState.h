...
class Agent_AnimRunningState : public Agent_AnimState
{
public:
	/**
	  ...
	  * @bug	    No know Bugs
	*/
	Agent_AnimRunningState(std::vector<sf::IntRect> sequence, sf::Texture* atlasMap, float fps, bool repeat);
	~Agent_AnimRunningState();
