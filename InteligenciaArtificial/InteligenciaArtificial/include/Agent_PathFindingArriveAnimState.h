...
*/
class Agent_PathFindingArriveAnimState : public Agent_PathFindingAnimState
{
public:
	/**
	  ...
	  * @bug	    No know Bugs
	*/
	Agent_PathFindingArriveAnimState(std::vector<sf::IntRect> sequence, sf::Texture* atlasMap, float fps, bool repeat);
	~Agent_PathFindingArriveAnimState();
