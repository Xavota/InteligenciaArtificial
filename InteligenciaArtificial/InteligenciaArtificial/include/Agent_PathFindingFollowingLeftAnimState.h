...
*/
class Agent_PathFindingFollowingLeftAnimState : public Agent_PathFindingAnimState
{
public:
	/**
	  ...
	  * @bug	    No know Bugs
	*/
	Agent_PathFindingFollowingLeftAnimState(std::vector<sf::IntRect> sequence, sf::Texture* atlasMap, float fps, bool repeat);
	~Agent_PathFindingFollowingLeftAnimState();
