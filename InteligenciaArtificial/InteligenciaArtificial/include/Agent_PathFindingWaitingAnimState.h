...
*/
class Agent_PathFindingWaitingAnimState : public Agent_PathFindingAnimState
{
public:
	/**
	  ...
	  * @bug	    No know Bugs
	*/
	Agent_PathFindingWaitingAnimState(std::vector<sf::IntRect> sequence, sf::Texture* atlasMap, float fps, bool repeat);
	~Agent_PathFindingWaitingAnimState();
