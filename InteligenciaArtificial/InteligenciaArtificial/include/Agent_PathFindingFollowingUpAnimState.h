...
*/
class Agent_PathFindingFollowingUpAnimState : public Agent_PathFindingAnimState
{
public:
	/**
	  ...
	  * @bug	    No know Bugs
	*/
	Agent_PathFindingFollowingUpAnimState(std::vector<sf::IntRect> sequence, sf::Texture* atlasMap, float fps, bool repeat);
	~Agent_PathFindingFollowingUpAnimState();
